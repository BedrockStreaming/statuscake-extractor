...
To configure the project, we use npm `config` package, follow `config/default.json` [https://www.npmjs.com/package/config](https://www.npmjs.com/package/config) example to define yours with:
